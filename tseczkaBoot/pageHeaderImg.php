...
<header class="container">
	<div class="row">
  <div id="logo" class="span8">  <h1><a href="<?php echo home_url();?>"><?php bloginfo('name'); ?></a></h1></div>
  <nav class="span8">	<?php wp_nav_menu( array('menu' => 'main', 'depth' => 3, 'menu_class'      => 'tabs'  )); ?> </nav>
  </div>
</header>
