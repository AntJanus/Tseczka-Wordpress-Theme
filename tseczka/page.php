...
<section id="main-content" class="row"><!-- MAIN CONTENT WRAPPER -->
  ...
  <section id="contentPosts" class="large-8 columns"><!-- content posts -->
...
<article id="post-<?php the_ID();?>" <?php post_class('post hentry hnews single');?>>
  ...
  <!-- meta 1 -->
  <p class="meta  vcard unseen"><time class="updated" datetime="<?php $postDate = get_the_date('c'); $postDate2 = get_the_date('d.m.Y'); echo $postDate ?>" pubdate> <?php echo $postDate2; ?></time>
